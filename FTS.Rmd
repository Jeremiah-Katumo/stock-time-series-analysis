...
NAME: JEREMIAH KATUMO KURWA
REG NO: TU01-SS213-0324/2018
COURSE: BSC STATISTICS 4.2
UNIT: FINANCIAL TIME SERIES
YEAR: 2022/2023
...
library(readxl)
library(tidyverse)
packages =  c("ggplot2", "dplyr", "tidyr", "data.table", 'corrplot', 'gridExtra',   'forecast', 'tseries', 'TSA', 'tibble', 'TTR', "fpp2", "TSstudio", "zoo", "xts",
              "recipes")
